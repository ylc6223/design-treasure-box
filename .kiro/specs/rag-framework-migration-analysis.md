...
```typescript
// LlamaIndex实现示例
import { VectorStoreIndex, QueryEngine, ServiceContext, StorageContext } from 'llamaindex';
...
const index = await VectorStoreIndex.fromVectorStore(vectorStore, serviceContext, storageContext);
