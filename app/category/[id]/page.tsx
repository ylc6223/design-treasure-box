...
export default function CategoryPage({ params }: CategoryPageProps) {
  ...
  const { data: resources, isLoading } = useResourcesByCategory(id);
    ...
    return (
      <div className="min-h-screen">
        <div className="container px-4 py-16 text-center">
          ...
          <p className="mt-4 text-muted-foreground">抱歉，您访问的分类不存在</p>
      ...
      <div className="container px-4 py-8">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {resources && (
                <p className="mt-4 text-sm text-muted-foreground">共 {resources.length} 个资源</p>
              )}
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            <p className="text-lg text-muted-foreground">该分类暂无资源</p>
          </div>
        )}
      </div>
    </div>
