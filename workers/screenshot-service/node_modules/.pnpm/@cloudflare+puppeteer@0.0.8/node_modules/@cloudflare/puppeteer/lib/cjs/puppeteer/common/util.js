...
async function getReadableAsBuffer(readable, path) {
    ...
    try {
        return node_buffer_1.Buffer.concat(buffers);
    }
    catch (error) {
        return null;
    }
