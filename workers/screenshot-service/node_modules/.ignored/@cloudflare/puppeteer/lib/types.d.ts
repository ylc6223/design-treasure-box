...
export declare const chunksToMessage: (chunks: Uint8Array[], sessionid: string) => string | null;
...
/* Excluded from this release type: deferredPromiseDebugTimeout */
...
export declare class HTTPResponse {
    ...
    export declare const launch: (endpoint: BrowserWorker, options?: LaunchOptions) => Promise<Browser>;
    ...
    export declare const messageToChunks: (data: string) => Uint8Array[];
    ...
    export declare class Page extends EventEmitter {
         ...
         */
        screenshot(options?: ScreenshotOptions): Promise<Buffer_2 | string>;
        /**
         ...
         * @returns
         */
        pdf(options?: PDFOptions): Promise<Buffer_2>;
        /**
