...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories for the Gemini (Design Treasure Box) project based on user requirements. Including strict adherence to Gemini project standards.
---
