...
describe('RatingStars', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<RatingStars rating={4.0} className="custom-class" />);
  ...
  it('applies correct text size for small stars', () => {
    const { container } = render(<RatingStars rating={4.0} size="sm" showValue />);
  ...
  it('applies correct text size for medium stars', () => {
    const { container } = render(<RatingStars rating={4.0} size="md" showValue />);
  ...
  it('applies correct text size for large stars', () => {
    const { container } = render(<RatingStars rating={4.0} size="lg" showValue />);
