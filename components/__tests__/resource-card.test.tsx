...
describe('ResourceCard', () => {
  it('renders resource information correctly', () => {
    ...
    render(<ResourceCard resource={mockResource} isFavorited={false} onFavorite={onFavorite} />);
  ...
  it('does not display featured badge when resource is not featured', () => {
    ...
    render(
      <ResourceCard resource={nonFeaturedResource} isFavorited={false} onFavorite={onFavorite} />
    );
  ...
  it('displays filled heart icon when resource is favorited', () => {
    ...
    const { container } = render(
      <ResourceCard resource={mockResource} isFavorited={true} onFavorite={onFavorite} />
    );
  ...
  it('displays correct number of stars for rating', () => {
    ...
    const { container } = render(
      <ResourceCard resource={mockResource} isFavorited={false} onFavorite={onFavorite} />
    );
  ...
  it('displays all tags when resource has 3 or fewer tags', () => {
    ...
    render(
      <ResourceCard resource={resourceWithFewTags} isFavorited={false} onFavorite={onFavorite} />
    );
