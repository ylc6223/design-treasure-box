...
export function BasicMasonryGridExample() {
  ...
  return (
    <MasonryGrid resources={resources} isFavorited={isFavorited} onFavorite={handleFavorite} />
  );
}
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-muted-foreground">{featuredResources.length} 个资源</span>
      </div>
    ...
    return (
      <div className="flex min-h-[400px] items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">浏览资源并点击爱心图标来收藏</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-muted-foreground">{favoriteResources.length} 个资源</span>
      </div>
